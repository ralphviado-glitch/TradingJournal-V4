...
describe("archived dual-scenario plans", () => {
  it("renders both historical plans and bottom line", () => {
    ...
    expect(html).toContain("Show Trade Plan"); expect(html).not.toContain("Show Long Plan"); expect(html).not.toContain("Show Short Plan"); expect(html).toContain('aria-expanded="false"'); expect(html).toContain("Wait for confirmation"); expect(html).toContain("No pre-market chart saved.");
    expect(html.indexOf("Show Trade Plan")).toBeLessThan(html.indexOf("Bottom Line"));
  });
